...
final class ActionsController extends BaseApiController
{
    ...
    #[Route(path: '/timesheet/{id}/{view}/{locale}', name: 'get_timesheet_actions', requirements: [
        'id' => '\d+',
    ], methods: ['GET'])]
    public function getTimesheetActions(Timesheet $timesheet, string $view, string $locale): Response
    {
        $event = new PageActionsEvent($this->getUser(), [
            'timesheet' => $timesheet,
        ], 'timesheet', $view);
    ...
    #[OA\Parameter(name: 'view', description: 'View to display the actions at (e.g. index, custom)', in: 'path', required: true)]
    #[OA\Parameter(name: 'locale', description: 'Language to translate the action title to (e.g. de, en)', in: 'path', required: true)]
    #[Route(path: '/activity/{id}/{view}/{locale}', name: 'get_activity_actions', requirements: [
        'id' => '\d+',
    ], methods: ['GET'])]
    ...
    #[OA\Parameter(name: 'view', description: 'View to display the actions at (e.g. index, custom)', in: 'path', required: true)]
    #[OA\Parameter(name: 'locale', description: 'Language to translate the action title to (e.g. de, en)', in: 'path', required: true)]
    #[Route(path: '/project/{id}/{view}/{locale}', name: 'get_project_actions', requirements: [
        'id' => '\d+',
    ], methods: ['GET'])]
    ...
    #[OA\Parameter(name: 'view', description: 'View to display the actions at (e.g. index, custom)', in: 'path', required: true)]
    #[OA\Parameter(name: 'locale', description: 'Language to translate the action title to (e.g. de, en)', in: 'path', required: true)]
    #[Route(path: '/customer/{id}/{view}/{locale}', name: 'get_customer_actions', requirements: [
        'id' => '\d+',
    ], methods: ['GET'])]
