 ...
 */
#[ORM\Table(name: 'platform_crm_activities')]
#[ORM\Index(columns: ['visible', 'project_id'])]
#[ORM\Index(columns: ['visible', 'project_id', 'name'])]
#[ORM\Index(columns: ['visible', 'name'])]
#[ORM\Entity(repositoryClass: 'App\Crm\Domain\Repository\ActivityRepository')]
...
class Activity implements EntityWithMetaFields, EntityWithBudget
{
     ...
     * @var Collection<Team>
     */
    #[ORM\JoinTable(name: 'platform_crm_activities_teams')]
